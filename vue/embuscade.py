...
class Ui_MainWindow(BasicWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_26.setContentsMargins(200, -1, 200, -1)
        ...
        self.labelLECONTENUDUJEU.setFont(font)
        ...
        self.labelRougeEquipeAjoutJoueur = QtWidgets.QLabel(self.verticalLayoutWidget_5)
        self.labelRougeEquipeAjoutJoueur.setStyleSheet("color: rgb(255, 0, 0);")
        self.labelRougeEquipeAjoutJoueur.setAlignment(QtCore.Qt.AlignCenter)
        self.labelRougeEquipeAjoutJoueur.setObjectName("labelRougeEquipeAjoutJoueur")
        ...
        self.pushButtonDeletePlayer.setStyleSheet("background-color: rgb(255,133,51);")
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(30, 130, 841, 291))
        ...
        font = QtGui.QFont()
        font.setPointSize(12)
        self.labelAProposContenu.setFont(font)
        self.labelAProposContenu.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.verticalLayoutWidget_18 = QtWidgets.QWidget(self.pageProfil)
        self.verticalLayoutWidget_18.setGeometry(QtCore.QRect(0, 10, 901, 80))
        ...
        self.labelTitreProfil = QtWidgets.QLabel(self.verticalLayoutWidget_18)
        self.labelTitreProfil.setStyleSheet("font: 26pt \"MS PGothic\";")
        self.labelTitreProfil.setObjectName("labelTitreProfil")
        self.verticalLayout_25.addWidget(self.labelTitreProfil, 0, QtCore.Qt.AlignHCenter)
        ...
        self.labelProfilMettreNom = QtWidgets.QLabel(self.verticalLayoutWidget_19)
        self.labelProfilMettreNom.setStyleSheet("font: 16pt \"Segoe UI\";")
        self.labelProfilMettreNom.setObjectName("labelProfilMettreNom")
        self.verticalLayout_30.addWidget(self.labelProfilMettreNom)
        self.labelprofilMettrePrenom = QtWidgets.QLabel(self.verticalLayoutWidget_19)
        self.labelprofilMettrePrenom.setStyleSheet("font: 16pt \"Segoe UI\";")
        self.labelprofilMettrePrenom.setObjectName("labelprofilMettrePrenom")
        self.verticalLayout_30.addWidget(self.labelprofilMettrePrenom)
        self.labelProfilMettrePseudo = QtWidgets.QLabel(self.verticalLayoutWidget_19)
        self.labelProfilMettrePseudo.setStyleSheet("font: 16pt \"Segoe UI\";")
        self.labelProfilMettrePseudo.setObjectName("labelProfilMettrePseudo")
        self.verticalLayout_30.addWidget(self.labelProfilMettrePseudo)
        ...
        self.pageHistoriquePartie.setObjectName("pageHistoriquePartie")
        self.verticalLayoutWidget_22 = QtWidgets.QWidget(self.pageHistoriquePartie)
        self.verticalLayoutWidget_22.setGeometry(QtCore.QRect(0, 10, 901, 80))
        self.verticalLayoutWidget_22.setObjectName("verticalLayoutWidget_22")
        self.verticalLayout_31 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_22)
        self.verticalLayout_31.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_31.setObjectName("verticalLayout_31")
        self.labelTitreProfil_2 = QtWidgets.QLabel(self.verticalLayoutWidget_22)
        self.labelTitreProfil_2.setStyleSheet("font: 26pt \"MS PGothic\";")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.BoutonMenuProfil.setText(_translate("MainWindow", "Profil"))
        ...
        self.labelTitreProfil.setText(_translate("MainWindow", "Profil"))
        self.pushButtonHistoriqueParties.setText(_translate("MainWindow", "Historique parties"))
        self.labelProfilNom.setText(_translate("MainWindow", "Nom :  "))
        self.labelProfilPrenom.setText(_translate("MainWindow", "Prénom :  "))
        self.labelProfilPseudo.setText(_translate("MainWindow", "Pseudo :  "))
        self.labelProfilMettreNom.setText(_translate("MainWindow", "TextLabel"))
        self.labelprofilMettrePrenom.setText(_translate("MainWindow", "TextLabel"))
        self.labelProfilMettrePseudo.setText(_translate("MainWindow", "TextLabel"))
        self.pushButtonProfilRetourMenu.setText(_translate("MainWindow", "Retour menu"))
        self.labelTitreProfil_2.setText(_translate("MainWindow", "Historique Parties"))
